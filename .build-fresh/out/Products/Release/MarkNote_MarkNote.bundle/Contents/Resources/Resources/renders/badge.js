...
window.__registerRenderPlugin({
  ...
  css: '.md-badge{display:inline-block;padding:2px 10px;border-radius:999px;font-size:0.78em;font-weight:600;line-height:1.5;background:var(--code-bg);color:var(--text);border:1px solid var(--border-strong);vertical-align:middle;}'
    + '.md-badge-green,.md-badge-success,.md-badge-ok{background:var(--tip-bg);color:var(--tip);border-color:var(--border-strong);}'
    + '.md-badge-red,.md-badge-danger{background:var(--danger-bg);color:var(--danger);border-color:var(--border-strong);}'
    + '.md-badge-orange,.md-badge-warning{background:var(--warn-bg);color:var(--warn);border-color:var(--border-strong);}'
    + '.md-badge-yellow{background:var(--warn-bg);color:var(--warn);border-color:var(--border-strong);}'
    + '.md-badge-blue,.md-badge-note,.md-badge-info{background:var(--note-bg);color:var(--note);border-color:var(--border-strong);}'
    + '.md-badge-purple{background:var(--accent-soft);color:var(--accent);border-color:var(--border-strong);}'
    + '.md-badge-gray,.md-badge-grey{background:var(--code-bg);color:var(--text-secondary);border-color:var(--border-strong);}'
    + '.md-badge-ink{background:var(--code-bg);color:var(--text);border-color:var(--border-strong);}'
    + '.md-badge-accent{background:var(--accent);color:var(--surface);border-color:var(--accent);}'
